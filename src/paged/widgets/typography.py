...
from src.utils.text_validation import get_text_complexity_warning
...
class TypeDisplayWidget(BaseWidget):
    ...
    def validate_parameters(self) -> None:
        ...
        # Warn about complex markdown structures (non-blocking)
        text = self.parameters.get("text", "")
        warning = get_text_complexity_warning(text, self.widget_type)
        if warning:
